...
Wire Wire Line
	3170 1220 3260 1220
Wire Wire Line
	10580 4310 10460 4310
Wire Wire Line
	10460 4460 10580 4460
Wire Wire Line
	5560 1880 5480 1880
$Comp
L power:GND #PWR0109
...
U 1 1 5D943E61
P 9410 6210
F 0 "#PWR0113" H 9410 5960 50  0001 C CNN
F 1 "GND" H 9415 6045 39  0000 C CNN
F 2 "" H 9410 6210 50  0001 C CNN
F 3 "" H 9410 6210 50  0001 C CNN
	1    9410 6210
	1    0    0    -1  
$EndComp
NoConn ~ 4680 1380
...
SDA
Text GLabel 10580 4310 2    50   BiDi ~ 0
SCL
Text GLabel 10580 4460 2    50   BiDi ~ 0
SDA
Wire Wire Line
	7510 1170 7330 1170
Wire Wire Line
...
Joysticks w/ ADC
Wire Wire Line
	10590 5210 10460 5210
Wire Wire Line
	10590 5360 10460 5360
Wire Wire Line
	10590 5510 10460 5510
$Comp
...
Wire Wire Line
	10520 840  10520 920 
Text GLabel 10600 5660 2    50   BiDi ~ 0
CS
Wire Wire Line
	10600 5660 10460 5660
Text GLabel 10420 850  1    50   BiDi ~ 0
Din
Text GLabel 10590 5510 2    50   BiDi ~ 0
Din
Wire Wire Line
	10420 850  10420 920 
Text GLabel 10590 5360 2    50   BiDi ~ 0
Dout
...
Wire Wire Line
	10220 860  10220 920 
Text GLabel 10590 5210 2    50   BiDi ~ 0
CLK
$Comp
L power:GND #PWR0110
U 1 1 5D9AADAF
...
SafeDrive
Text GLabel 10590 4610 2    50   BiDi ~ 0
TankDrive
Text GLabel 10590 4760 2    50   BiDi ~ 0
SafeDrive
Wire Wire Line
	10590 4610 10460 4610
Wire Wire Line
	10590 4760 10460 4760
Wire Notes Line
	9460 3720 9460 2750
Wire Notes Line
...
U 1 1 5D86DCF0
P 9710 4010
F 0 "ESP-12E1" H 9710 4125 50  0000 C CNN
F 1 "ESP8266_NodeMCU" H 9710 4034 50  0000 C CNN
F 2 "MRDT_Controller_Board:ESP8266_nodeMCU" H 9710 4010 50  0001 C CNN
F 3 "https://components101.com/sites/default/files/component_datasheet/ESP12E%20Datasheet.pdf" H 9710 4010 50  0001 C CNN
	1    9710 4010
	1    0    0    -1  
$EndComp
NoConn ~ 3260 2020
...
$EndComp
$Comp
L MRDT_Actives:LED3P PWR
U 1 1 5D9FE86E
P 1130 3090
F 0 "PWR" V 1277 3319 60  0000 L CNN
...
$EndComp
$Comp
L MRDT_Actives:LED3P COM
U 1 1 5DA02666
P 1930 3080
F 0 "COM" V 2077 3308 60  0000 L CNN
...
D0
Text GLabel 10580 4160 2    50   Output ~ 0
D0
Wire Wire Line
	10580 4160 10460 4160
NoConn ~ 10620 2120
NoConn ~ 10720 2120
Wire Wire Line
	5240 870  5080 870 
...
SW4
Text GLabel 8880 4610 0    50   Input ~ 0
SW1
Text GLabel 8870 4760 0    50   Input ~ 0
SW2
Text GLabel 8870 4910 0    50   Input ~ 0
SW3
Wire Wire Line
	8880 4610 8960 4610
Wire Wire Line
...
Text GLabel 8880 5060 0    50   Input ~ 0
SW4
...
5V
Text GLabel 9560 6210 3    50   Input ~ 0
5V
$Comp
L power:GND #PWR0101
U 1 1 5DDD60BD
...
Wire Wire Line
	1950 1200 1950 1500
$Comp
L RF_Module:ESP-12E ESP-12E
U 1 1 5DC18923
P 4820 3930
F 0 "ESP-12E" H 4820 4911 50  0000 C CNN
F 1 "ESP-12E" H 4820 4820 50  0000 C CNN
F 2 "RF_Module:ESP-12E" H 4820 3930 50  0001 C CNN
F 3 "http://wiki.ai-thinker.com/_media/esp8266/esp8266_series_modules_user_manual_v1.1.pdf" H 4470 4030 50  0001 C CNN
	1    4820 3930
	1    0    0    -1  
$EndComp
$EndSCHEMATC
